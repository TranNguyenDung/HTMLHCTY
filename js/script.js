...
const pesion = { age2: 15, name2: 'Vinh' };
const name = pesion.name1;
const age1 = pesion.age2;
const { name2, age2 } = pesion;
...
http.createServer(function (req, res) {
	...
	// res.write("xin chao ban, ban co khoe khong");
	// console.log(res.socket);
	// return res.end();
	console.log('------------------------');
	console.log(req);
	fs.readFile('./js/data1.txt', (err, data) => {
		// fs.readFile("Page01.html" ,(err,data) => {
	...
	// fs.readFile('C:/Users/MY PC/Desktop/HHTML/HTMLHCTY/js/data1.text', function (err, data) {
	// 	res.writeHead(200, { 'Content-Type': 'text/html' });
	// 	res.write(data);
	// 	console.log('Có thiết bị kết nối');
	// 	return res.end();
...
// const request = path.get("file://192.168.1.253/06_List%20XEAL40D%20To%20XEAL4SP/XEAL4DSP_20210317_133957.AL4DSP",
//     function(response) {
//         //response.pipe(file);
